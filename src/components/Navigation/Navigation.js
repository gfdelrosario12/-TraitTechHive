      ...
      <div>
        <Link to="/" className="title-font fs-2">
          <div className="d-flex flex-row align-items-center">
            ...
            <h1 className="ms-2 title-font fs-5">TraitTechHive</h1>
          </div>
        </Link>
